...
<section class="">
    <div class="py-8 px-4 mx-auto my-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div class="max-w-screen-lg py-20 sm:py-20 lg:py-20 ">
            ...
            <p class="mb-4 text-xl text-white pt-3 font-body " style="text-indent: 2.5em;">{{$itemw->description}}
            </p>
            <br>
...
<section class="" id="Services">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 py-16">
            ...
            <a href="/content" class="flex flex-none bg-bgcard p-3 rounded-md shadow-[0_10px_15px_-2px_rgba(0,0,0,0.3)] shadow-indigo-700/50 hover:shadow-purple-600/60">
