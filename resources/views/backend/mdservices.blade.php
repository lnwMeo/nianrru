  ...
  <div class=" p-3 ">
      <form method="POST" action="/storeservice" enctype="multipart/form-data">
          ...
          <textarea id="content" name="content" rows="4" class="font-body bg-hero-bgindex bg-cover mt-2 bg-gray-50 border border-gray-300  focus:outline-none focus:ring focus:ring-violet-300 text-white text-md rounded-md  block w-full p-2 " placeholder="เพิ่มคำอธิบาย..."></textarea>
          @error('content')
          <div class="font-body text-red-700 text-md">
              <span>{{$message}}</span>
          </div>
