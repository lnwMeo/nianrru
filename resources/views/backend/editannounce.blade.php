...
<div class="pt-5">
    <div class="p-5 mb-4 rounded shadow-lg ">
        <p class="text-3xl font-body pb-3"> แก้ไข ประกาศ </p>
        <form method="POST" action="{{route('updateAn',$announces->id)}}" enctype="multipart/form-data">
            ...
            <input class="mt-2 bg-gray-50 border border-gray-300  focus:outline-none focus:ring focus:ring-violet-300 text-gray-900 text-md rounded-md  block w-full p-2" aria-describedby="user_avatar_help" id="imgannounce" name="imgannounce" type="file">
