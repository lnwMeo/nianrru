    ...
    <section class="">
        ...
        <div class="py-8 px-4 mx-auto my-auto max-w-screen-xl lg:py-16 lg:px-6">
            ...
            <div class="max-w-screen-xl py-2 sm:py-2 lg:py-2 ">
                ...
                <p class="mb-4 text-md tracking-tight font-medium dark:text-white font-body">eduroam ย่อมาจาก “educational roaming” ที่จดทะเบียนโดย TERENA ที่ก่อกำเนิดจากเครือข่ายการศึกษาและวิจัยของยุโรป (NRENs) เพื่อการใช้งานเครือข่ายที่เรียบง่าย ปลอดภัย และรองรับผู้ใช้งานที่ขยายตัวเพิ่มมากขึ้นบนเครือข่ายไวเลสแลน (Wireless LAN) ได้
                ...
                <p class="mb-4 text-md tracking-tight font-medium dark:text-white font-body">ประโยชน์บริการ eduroam<br>
                    ...
                    <br> 2. นักศึกษา อาจารย์ และบุคลากรของมหาวิทยาลัยหรือหน่วยงานทางการศึกษาอื่นที่เป็นสมาชิกกับ eduroam สามารถเข้าใช้และใช้งานเครือข่ายอินเทอร์เน็ตผ่านเครือข่ายคอมพิวเตอร์ของ มหาวิทยาลัยราชภัฏนครราชสีมา ได้
                    <br> 3. นักศึกษา อาจารย์ และบุคลากรสามารถเข้าเชื่อมต่อสัญญาณไวเลสแลนผ่านชื่อ SSID ที่ประกาศ "eduroam" โดยทุกสถาบันที่เป็นสมาชิกกับ eduroam กำหนดชื่อดังกล่าวเหมือนกัน ด้วยบัญชีผู้ใช้งานอินเทอร์เน็ต (Nrru IT Account)
                </p>
